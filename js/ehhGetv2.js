var elementCollection = document.getElementsByTagName("body");
...
output = {};
var processedEntity = iterationConductor(elementCollection, output, "get");

console.log("output", processedEntity);

function iterationConductor(entity) {
